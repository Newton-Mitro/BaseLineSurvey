...
CREATE TABLE dbo.ToiletAndWaterInfos (
    ...
    , CONSTRAINT FK_ToiletAndWaterInfos_ToiletAndWaterOptions FOREIGN KEY (OptionId) REFERENCES ToiletAndWaterOptions(ToiletAndWaterOptionId)
    , CONSTRAINT FK_ToiletAndWaterInfos_ToiletAndWaterQuestions FOREIGN KEY (QuestionId) REFERENCES ToiletAndWaterQuestions(ToiletAndWaterQuestionId)
