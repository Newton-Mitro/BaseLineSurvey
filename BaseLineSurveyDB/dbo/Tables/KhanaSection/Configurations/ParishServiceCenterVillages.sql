...
CREATE TABLE [dbo].[ParishServiceCenterVillages] (
    ...
    , ParishesServicentersId BIGINT NOT NULL
    ...
    , CONSTRAINT [FK_PariseServiceCenterVillages_ParisesServicenters] FOREIGN KEY (ParishesServicentersId) REFERENCES [ParishesServicenters]([ParishesServicentersId])
    )
