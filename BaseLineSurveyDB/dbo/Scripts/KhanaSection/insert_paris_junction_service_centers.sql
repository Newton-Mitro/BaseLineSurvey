...
DECLARE @MausaidParish1 BIGINT = 10
DECLARE @TejgaonParish1 BIGINT = 11
DECLARE @BanaiSeminarPastoralCenter1 BIGINT = 12
DECLARE @MohakhaliChurch1 BIGINT = 13
DECLARE @UttaraChurch1 BIGINT = 14
DECLARE @KafrulQuasiParish1 BIGINT = 15
DECLARE @NaynagarParish1 BIGINT = 16
DECLARE @VataraParish1 BIGINT = 17
DECLARE @MohammadpurParish1 BIGINT = 18
DECLARE @MirpurParish1 BIGINT = 19
DECLARE @OtherChurch1 BIGINT = 20
DECLARE @NagariParish1 BIGINT = 21
DECLARE @TumiliaParish1 BIGINT = 22
DECLARE @RangamatiaParish1 BIGINT = 23
DECLARE @MathbariParish1 BIGINT = 24
DECLARE @DoriparaParish1 BIGINT = 25
DECLARE @BhadunParish1 BIGINT = 26
DECLARE @FaucalChurchCentre1 BIGINT = 27
DECLARE @KewachalaChurchCentre1 BIGINT = 28
DECLARE @PagarParish1 BIGINT = 29
